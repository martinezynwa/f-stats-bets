...
CREATE TABLE IF NOT EXISTS "PlayerToTeam" (
    ...
    "isDebutSeason" BOOLEAN NOT NULL DEFAULT FALSE,
...
CREATE TABLE IF NOT EXISTS "PlayerStatus" (
    ...
    "isWithoutClub" BOOLEAN NOT NULL
);
...
ALTER TABLE "PlayerStatus" ENABLE ROW LEVEL SECURITY;
